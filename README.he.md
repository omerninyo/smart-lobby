...
## 📺 המלצות לאפליקציות Kiosk ונעילת מסך באנדרואיד

עבור התקנה קבועה בלובי (טאבלטים או מסכי מגע צמודי קיר 24/7), אנו ממליצים על שתי אפליקציות מצטיינות:

### 🥇 1. [Webview Kiosk](https://webviewkiosk.nktnet.uk) (המלצה ראשית - 100% חינמי וקוד פתוח)
* 🆓 **100% קוד פתוח וחינמי (FOSS):** ללא הגבלות, ללא סימני מים וללא צורך ברישיונות בתשלום.
* 📱 **מותאם במיוחד למכשירים ישנים:** עובד חלק ומהיר על טאבלטים ישנים עם גרסאות אנדרואיד מוקדמות וצריכת זיכרון מינימלית.
* 🔒 **נעילת משימות (Lock Task Mode):** נעילת המסך לאפליקציה בודדת, הסתרת שורת הסטטוס ומניעת יציאה.
* 🛡️ **הגנת הגדרות בסיסמה/ביומטריה:** נעילת תפריט ההגדרות למניעת שינויים ע"י עוברי אורח.
* 📦 **התקנה פשוטה:** זמין ב-[Google Play](https://play.google.com/store/apps/details?id=uk.nktnet.webviewkiosk), ב-[F-Droid](https://f-droid.org/) ובהורדת APK ישירה מ-[GitHub](https://github.com/nktnet1/webview-kiosk).

---

### 🥈 2. [Fully Kiosk Browser](https://www.fully-kiosk.com/) (התקן המסחרי המתקדם)
* ⚡ **עבודה חלקה ב-60fps** עם הפעלה אוטומטית (Auto-Start) לאחר הפסקת חשמל.
* 🔒 **נעילת Kiosk מלאה** המונעת מעוברי אורח לצאת מהאפליקציה.
* 💡 **זיהוי תנועה במצלמה (Motion Detection):** הדלקת המסך כשמישהו ניגש למעלית/לובי.
